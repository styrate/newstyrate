...
import type { Row, UpdateNotification } from "../../hooks/useNotifications";

const fields: Array<keyof UpdateNotification> = [
  "id",
  "user_id",
  "type",
  "content",
...
export default function UpdateNotifications({
  ...
  const handleSubmit: FormEventHandler = (event) => {
    ...
    const target = event.target as typeof event.target & UpdateNotification;
    ...
    const updatedRow = fields
      ...
      .reduce(
        ...
        {} as Record<keyof UpdateNotification, any>,
      );
