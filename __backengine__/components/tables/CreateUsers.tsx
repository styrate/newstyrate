...
import type { Row, InsertUser } from "../../hooks/useUsers";

const fields: Array<keyof InsertUser> = [
  "id",
  "points",
  "username",
  "email",
...
export default function CreateUsers({
  ...
  onCreate: (newRow: InsertUser) => Promise<Row | undefined>;
  ...
  const handleSubmit: FormEventHandler = (event) => {
    ...
    const target = event.target as typeof event.target & InsertUser;
    const newRow = fields
      ...
      .reduce(
        ...
        {} as Record<keyof InsertUser, any>,
      );
    onCreate(newRow)
      .then((task) => {
        if (task) {
