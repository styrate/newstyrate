...
import type { Row, UpdateContest } from "../../hooks/useContests";

const fields: Array<keyof UpdateContest> = [
  "id",
  "name",
  "description",
...
export default function UpdateContests({
  onUpdate,
  onFetch,
}: {
  onUpdate: (
    id: Row["id"],
    updatedRow: UpdateContest,
  ...
  const handleSubmit: FormEventHandler = (event) => {
    ...
    const target = event.target as typeof event.target & UpdateContest;
    ...
    const updatedRow = fields
      ...
      .reduce(
        ...
        {} as Record<keyof UpdateContest, any>,
      );
