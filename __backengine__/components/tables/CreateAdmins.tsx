...
import type { Row, InsertAdmin } from "../../hooks/useAdmins";

const fields: Array<keyof InsertAdmin> = ["id", "user_id"];

export default function CreateAdmins({
  onCreate,
  onFetch,
}: {
  onCreate: (newRow: InsertAdmin) => Promise<Row | undefined>;
  ...
  const handleSubmit: FormEventHandler = (event) => {
    ...
    const target = event.target as typeof event.target & InsertAdmin;
    const newRow = fields
      ...
      .reduce(
        ...
        {} as Record<keyof InsertAdmin, any>,
      );
    onCreate(newRow)
      .then((task) => {
        if (task) {
