...
import type { Row, UpdateCategory } from "../../hooks/useCategories";

const fields: Array<keyof UpdateCategory> = ["id", "name"];
...
export default function UpdateCategories({
  ...
  const handleSubmit: FormEventHandler = (event) => {
    ...
    const target = event.target as typeof event.target & UpdateCategory;
    ...
    const updatedRow = fields
      ...
      .reduce(
        ...
        {} as Record<keyof UpdateCategory, any>,
      );
