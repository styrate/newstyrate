...
import type { Row, InsertNotification } from "../../hooks/useNotifications";

const fields: Array<keyof InsertNotification> = [
  "id",
  "user_id",
  "type",
  "content",
...
export default function CreateNotifications({
  ...
  onCreate: (newRow: InsertNotification) => Promise<Row | undefined>;
  ...
  const handleSubmit: FormEventHandler = (event) => {
    ...
    const target = event.target as typeof event.target & InsertNotification;
    const newRow = fields
      ...
      .reduce(
        ...
        {} as Record<keyof InsertNotification, any>,
      );
    onCreate(newRow)
      .then((task) => {
        if (task) {
