...
import type { Row, UpdateAdmin } from "../../hooks/useAdmins";

const fields: Array<keyof UpdateAdmin> = ["id", "user_id"];
...
export default function UpdateAdmins({
  ...
  const handleSubmit: FormEventHandler = (event) => {
    ...
    const target = event.target as typeof event.target & UpdateAdmin;
    ...
    const updatedRow = fields
      ...
      .reduce(
        ...
        {} as Record<keyof UpdateAdmin, any>,
      );
